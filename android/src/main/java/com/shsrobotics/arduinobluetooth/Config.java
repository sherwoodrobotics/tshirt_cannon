package com.shsrobotics.arduinobluetooth;
 ...
 *
 * A Config specifies what each button on the Controls screen does
 * By making it Serializable, we can easily save one to file
 */
...
public class Config implements Serializable {
    ...
    public void setCommand(int id, String command, String serviceUUID, String charUUID) {
        ...
        if (keySet.containsKey(id)) {
            ...
            //Except commands because they will always load regardless
            k.command = command;
